  ...
  >
	  <div class="app__modal modal">
		  ...
		  <div class="modal__header">
		    <h3 class="modal__title">Добавление пользователя</h3>
		  </div>
		  <div class="modal__content">
			  <form class="form">
				  ...
				  <div class="form__row">
				    <button
					  class="form__button button --blue"
...
export default {
    ...
    methods: {
		...
		updateUsers() {
			...
			localStorage.roistatStorage = JSON.stringify(this.usersTree);
			this.closeModal();
		},
	},
	computed: {
